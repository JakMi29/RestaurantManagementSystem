...
import classes from '../meals/MealPage.module.css';
...
function OrderMealsPage() {
    ...
    const handleNextPage = () => {
        ...
        setPageNumber(page);
        navigate(`/orderMeals?category=${currentCategory}&pageNumber=${page}&pageSize=${10}`);
    };
    ...
    const handleSearchChange = (event) => {
        ...
        search === "" ? navigate(`/orderMeals?category=${currentCategory}&pageNumber=0&pageSize=10`) :
            navigate(`/orderMeals?category=${currentCategory}&pageNumber=0&pageSize=10&searchTerm=${search}`);
    };
...
export async function loader({ request }) {
    ...
    const pageSize = 10;
    return defer({
        meals: await loadOrderMeals(category, pageNumber, pageSize, searchTerm),
    });
}
